...
const renders={
  cover:(s,i)=>page(s,i,
    '<div class="cover-type"><p class="cover-host">AI郵報 presents</p><h1><span class="hundred">100K<span class="asterisk">'+icon('asterisk')+'</span></span><span class="openlab">OPEN LAB</span></h1><p class="deck-label">'+esc(s.label)+'</p></div>'+waves()+
